        ...
        <div className="lg:col-span-1 flex flex-col space-y-6">
          ...
          <div className="glass-panel p-6 rounded-[24px] border border-white/5 bg-black/20 shadow-xl">
            ...
            <form onSubmit={handleGenerate} className="space-y-4">
              <input
                type="text"
                className="w-full pl-5 pr-5 py-3.5 bg-zinc-900/80 border border-white/10 rounded-[16px] focus:ring-2 focus:ring-purple-500/50 outline-none transition-all text-sm placeholder-zinc-500 text-zinc-100 shadow-inner"
              ...
              >
                {loading ? (
                  ...
                  <><Plus size={20} className="mr-1.5"/> Generate</>
                )}
              </button>
            </form>
          </div>
